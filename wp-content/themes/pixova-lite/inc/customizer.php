...
function pixova_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'pixova_lite_intro_slider' ,
			array(
					'title'       		=> __( 'Header Slider', 'pixova-lite' ),
					'panel' 			=> 'pixova_lite_panel_intro'
			)
	);
	...
	$wp_customize->add_control( new Pixova_Lite_Disabled_Custom_Control(
					...
					array(
							'type'      => 'textarea',
							'label' 	=> __('Enter Slide #1 Image URL ', 'pixova-lite'),
	...
	$wp_customize->add_section( 'pixova_lite_intro_what_we_do_1' ,
		array(
			'title'       		=> __( 'What we do #1', 'pixova-lite' ),
                        'description'           => __('Use the controls below to change the way the what we do icons & text look.', 'pixova-lite'),
			'panel' 			=> 'pixova_lite_panel_intro'
		)
	);
                ...
                $wp_customize->add_setting('pixova_lite_intro_what_we_do_1_icon',
                        array(
                                'sanitize_callback' => 'pixova_lite_sanitize_checkbox',
                                'default' => __('fa fa-droplet', 'pixova-lite'),
                        )
                );
                ...
                $wp_customize->add_control( new Pixova_Lite_Disabled_Custom_Control(
                                ...
                                array(
                                        'type'                  => 'text',
                                        'label' 		=> __('Specify icon name', 'pixova-lite'),
		...
		array(
			...
			'panel' 			=> 'pixova_lite_panel_intro'
                ...
                $wp_customize->add_setting('pixova_lite_intro_what_we_do_2_icon',
                        array(
                                'sanitize_callback' => 'pixova_lite_sanitize_checkbox',
                                'default' => __('fa fa-development', 'pixova-lite'),
                        )
                );
		...
		array(
			...
			'panel' 		=> 'pixova_lite_panel_intro'
                ...
                $wp_customize->add_setting('pixova_lite_intro_what_we_do_3_icon',
                        array(
                                'sanitize_callback' => 'pixova_lite_sanitize_checkbox',
                                'default' => __('fa fa-envelope', 'pixova-lite'),
                        )
                );
	...
	$wp_customize->add_section( 'pixova_lite_news_button' ,
			array(
					'title'       => __( 'Button', 'pixova-lite' ),
					'priority'    => 2,
					'panel' 	  => 'pixova_lite_panel_news'
	...
	/* Section Title */
			...
			$wp_customize->add_setting( 'pixova_lite_news_section_button_text',
					array(
							'sanitize_callback' => 'sanitize_text_field',
							'default' => __( 'Visit our blog', 'pixova-lite')
					)
			);
			...
			$wp_customize->add_control(
					...
					array(
							'label' 	=> __( 'Text', 'pixova-lite' ),
							'section' 	=> 'pixova_lite_news_button',
							'priority' 	=> 1,
					)
			);
			...
			/* Section Title */
				...
				if( is_plugin_active('contact-form-7/wp-contact-form-7.php') && is_plugin_active( 'pirate-forms/pirate-forms.php' ) ) {
					$contact_section_type = array(
						'contact-form-7'	=> __( 'Contact Form 7', 'pixova-lite' ),
						'pirate-forms'		=> __( 'Pirate Forms', 'pixova-lite' )
					);
				...
				$wp_customize->add_control( 'pixova_lite_contact_section_type', array(
					...
					'label'				=> __( 'Select the type of Contact Form to show (Contact Form 7 or Pirate Forms)', 'pixova-lite' ),
					'type'				=> 'radio',
					'priority'			=> 1,
